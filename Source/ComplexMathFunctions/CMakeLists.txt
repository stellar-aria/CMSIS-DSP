...
target_sources(CMSISDSP PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_mag_q31.c
  ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_mag_q15.c
  ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_mag_fast_q15.c
  ...
  ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_mag_f64.c
  ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_mag_squared_f32.c
  ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_mag_squared_f64.c
  ...
  ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_mult_cmplx_f64.c
...
if((NOT ARMAC5) AND(NOT DISABLEFLOAT16))
  target_sources(CMSISDSP PRIVATE 
    ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_conj_f16.c
    ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_dot_prod_f16.c
    ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_mag_f16.c
    ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_mag_squared_f16.c
    ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_mult_cmplx_f16.c
    ${CMAKE_CURRENT_LIST_DIR}/arm_cmplx_mult_real_f16.c
  )
endif()
